                                ...
                                <fieldset>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div
                                            ...
                                            <label class="form-check-label">{{ __('Grp sanguin') }}</label>
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="boursier"
                                                class="form-control{{ $errors->has('boursier') ? ' is-invalid' : '' }}"
                                                placeholder="{{ __('Name') }}"
                                                value="{{ old('boursier', auth()->user()->name) }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="mailto:{!! $student->email_ecole !!}">{!! $student->email_ecole !!}</a>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown">
